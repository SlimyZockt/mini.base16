...
H.apply_palette = function(palette, use_cterm, transparent)
    ...
    hi('Normal', { fg = p.base05, bg = "NONE", attr = nil, sp = nil })
    hi('NormalFloat', { fg = p.base05, bg = "NONE", attr = nil, sp = nil })
    ...
    if H.has_integration('saghen/blink.cmp') then
        ...
        hi('BlinkCmpMenuBorder', { link = 'Pmenu' })
        hi('BlinkCmpMenuSelection', { link = 'PmenuSel' })
        hi('BlinkCmpScrollBarThumb', { link = 'PmenuThumb' })
        hi('BlinkCmpScrollBarGutter', { link = 'PmenuSbar' })

        -- Labels
        hi('BlinkCmpLabel', { link = 'Pmenu' })
        hi('BlinkCmpLabelDeprecated', { link = 'PmenuExtra' })
        hi('BlinkCmpLabelMatch', { link = 'Pmenu' })
        hi('BlinkCmpLabelDetail', { link = 'PmenuExtra' })
        hi('BlinkCmpLabelDescription', { link = 'PmenuExtra' })

        -- Kinds
        hi('BlinkCmpKind', { link = 'PmenuKind' })
        hi('BlinkCmpSource', { link = 'PmenuExtra' })

        -- Ghost text
        hi('BlinkCmpGhostText', { link = 'NonText' })

        -- Documentation
        hi('BlinkCmpDoc', { link = 'NormalFloat' })
        hi('BlinkCmpDocBorder', { link = 'NormalFloat' })
        hi('BlinkCmpDocSeparator', { link = 'NormalFloat' })
        hi('BlinkCmpDocCursorLine', { link = 'Visual' })

        -- Signature help
        hi('BlinkCmpSignatureHelp', { link = 'NormalFloat' })
        hi('BlinkCmpSignatureHelpBorder', { link = 'NormalFloat' })
        hi('BlinkCmpSignatureHelpActiveParameter', { link = 'LspSignatureActiveParameter' })

        -- Specific kinds (BlinkCmpKind<kind> expands into these)
